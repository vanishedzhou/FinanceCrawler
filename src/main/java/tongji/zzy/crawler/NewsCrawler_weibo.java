...
public class NewsCrawler_weibo implements PageProcessor{
	private static final Logger logger = FCLog.getLogger(NewsCrawler_weibo.class);
	...
	public static void main(String[] args) {
		Spider.create(new NewsCrawler_weibo()).addUrl("http://futures.hexun.com/")
