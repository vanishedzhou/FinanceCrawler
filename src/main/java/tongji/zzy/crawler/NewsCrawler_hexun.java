...
public class NewsCrawler_hexun implements PageProcessor{
	private static final Logger logger = FCLog.getLogger(NewsCrawler_hexun.class);
	...
	public static void main(String[] args) {
		Spider.create(new NewsCrawler_hexun()).addUrl("http://futures.hexun.com/")
