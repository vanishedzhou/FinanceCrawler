...
public class DisclosureCrawler_old implements PageProcessor {
	private static final Logger logger = FCLog.getLogger(DisclosureCrawler_old.class);
	...
	public static void main(String[] args) {
		...
		for (DisclosureCategory dc : DisclosureCategory.values()) {
			...
			Spider.create(new DisclosureCrawler_old()).addUrl(getSpecifiedDisclosureCategoryUrl(dc.toString())).run();
		}
